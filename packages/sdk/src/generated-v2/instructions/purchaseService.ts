...
export function getPurchaseServiceInstructionDataDecoder(): Decoder<PurchaseServiceInstructionData> {
  return transformDecoder(
    ...
    value => ({
      ...value,
      discriminator:
        value.discriminator instanceof Uint8Array
          ? value.discriminator
          : new Uint8Array(value.discriminator),
    })
  );
}
...
export function getServicePurchaseDataCodec(): Codec<
  ServicePurchaseDataArgs,
  ServicePurchaseData
> {
  return combineCodec(
    getServicePurchaseDataEncoder(),
    getServicePurchaseDataDecoder()
  );
}
