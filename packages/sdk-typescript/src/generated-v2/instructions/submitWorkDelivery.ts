...
export type SubmitWorkDeliveryInstruction = IInstruction<string> & IInstructionWithData<Uint8Array> & IInstructionWithAccounts<IAccountMeta<string>[]>;
...
export function getSubmitWorkDeliveryInstruction(
  ...
  const programAddress = 'PodAI111111111111111111111111111111111111111' as Address<string>;
