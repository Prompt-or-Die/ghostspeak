...
export const AGENT_ACCOUNT_SIZE =
  ...
  FIELD_SIZES.STRING_PREFIX +
  VARIABLE_LIMITS.AGENT_METADATA_URI + // metadata_uri
...
export const MESSAGE_ACCOUNT_SIZE =
  ...
  FIELD_SIZES.STRING_PREFIX +
  VARIABLE_LIMITS.MESSAGE_PAYLOAD + // payload
...
export const CHANNEL_ACCOUNT_SIZE =
  ...
  FIELD_SIZES.STRING_PREFIX +
  VARIABLE_LIMITS.CHANNEL_NAME + // name
  FIELD_SIZES.STRING_PREFIX +
  VARIABLE_LIMITS.CHANNEL_DESCRIPTION + // description
...
export const INVITATION_ACCOUNT_SIZE =
  ...
  FIELD_SIZES.STRING_PREFIX +
  VARIABLE_LIMITS.INVITE_MESSAGE + // message
  FIELD_SIZES.U64 + // created_at
  FIELD_SIZES.U64 + // expires_at
  FIELD_SIZES.BUMP; // bump
...
export const CHANNEL_MESSAGE_ACCOUNT_SIZE =
  ...
  FIELD_SIZES.PUBKEY + // sender
  FIELD_SIZES.STRING_PREFIX +
  VARIABLE_LIMITS.MESSAGE_PAYLOAD + // content
  FIELD_SIZES.U8 + // message_type enum
  FIELD_SIZES.U64 + // timestamp
...
export class AccountFilters {
   ...
   */
  static createDataSizeFilter(accountType: keyof typeof ACCOUNT_SIZES): {
    dataSize: number;
  } {
   ...
   */
  static createDiscriminatorFilter(
    accountType: keyof typeof ACCOUNT_DISCRIMINATORS
  ): {
  ...
  static createAccountFilters(
    ...
    return [
      ...
      AccountFilters.createDiscriminatorFilter(
        accountType as keyof typeof ACCOUNT_DISCRIMINATORS
      ),
      ...additionalFilters,
    ];
  }
    ...
    return {
      ...
      agent: {
        ...
        reputation:
          ...
          FIELD_SIZES.U64 +
          FIELD_SIZES.STRING_PREFIX +
          VARIABLE_LIMITS.AGENT_METADATA_URI,
      },
      ...
      message: {
        ...
        messageType:
          ...
          FIELD_SIZES.PUBKEY +
          FIELD_SIZES.STRING_PREFIX +
          VARIABLE_LIMITS.MESSAGE_PAYLOAD +
          VARIABLE_LIMITS.MESSAGE_PAYLOAD_HASH,
        status:
          ACCOUNT_OVERHEAD +
          FIELD_SIZES.PUBKEY +
          FIELD_SIZES.PUBKEY +
      ...
      channel: {
        ...
        visibility:
          ...
          FIELD_SIZES.PUBKEY +
          FIELD_SIZES.STRING_PREFIX +
          VARIABLE_LIMITS.CHANNEL_NAME +
          FIELD_SIZES.STRING_PREFIX +
          VARIABLE_LIMITS.CHANNEL_DESCRIPTION,
      },
...
export function estimateDataTransfer(
  ...
  const recommendedBatchSize = Math.min(
    maxPerCall,
    Math.max(10, Math.floor(maxPerCall * 0.8))
  );
